...
public class Autotransition implements Serializable {
	...
	@Size(min = 1, max = 1, groups = AutotransitionValidation.class)
	private String autotranIsactive;

	@Column(name="AUTOTRAN_LOGICALOPERAND")
	@NotNull(groups = {AutotransitionValidation.class})
	@Size(min = 2, max = 3, groups = { AutotransitionValidation.class})
	private String autotranLogicaloperand;

	@Column(name="AUTOTRAN_NAME")
	@NotNull(groups = {AutotransitionValidation.class})
	@Size(min = 4, max = 30, groups = { AutotransitionValidation.class})
